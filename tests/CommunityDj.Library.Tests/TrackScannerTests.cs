...
namespace CommunityDj.Library.Tests;
...
public class TrackScannerTests
{
    ...
    {
        var dir = Directory.CreateTempSubdirectory("communitydj_test_");
        try
        {
    ...
    {
        var tracks = await TrackScanner.ScanAsync("/tmp/communitydj_does_not_exist_xyz");
        Assert.Empty(tracks);
    }
