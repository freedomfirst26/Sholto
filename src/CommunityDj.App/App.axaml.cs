...
using CommunityDj.Storage;
using CommunityDj.Controller;
using CommunityDj.Library;
using CommunityDj.App.ViewModels;
using CommunityDj.App.Views;
using TrackRow = CommunityDj.App.ViewModels.TrackRow;

namespace CommunityDj.App;
...
public partial class App : Application
{
    ...
    private void InitializeServices(MainViewModel vm, IClassicDesktopStyleApplicationLifetime desktop)
    {
        ...
        _ = Task.Run(async () =>
        {
            try
            {
                _db = await CommunityDjDatabase.OpenAsync();
