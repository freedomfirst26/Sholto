...
namespace CommunityDj.App.Theming;
...
/// </summary>
public sealed record CommunityDjTheme(
    string Name,
...
public static class Themes
{
    ...
    public static CommunityDjTheme Classic { get; } = new(
        Name: "Classic",
        BgDeep:        B("#111111"),
        Surface:       B("#1A1A1A"),
    ...
    public static CommunityDjTheme Plasma { get; } = new(
        Name: "Plasma",
        BgDeep:        B("#0B0918"),
        Surface:       B("#16122B"),
    ...
    public static CommunityDjTheme Serato { get; } = new(
        Name: "Serato",
        BgDeep:        B("#0F0F0F"),
        Surface:       B("#161616"),
    ...
    public static IReadOnlyList<CommunityDjTheme> All { get; } = [Classic, Plasma, Serato];
}
