...
public sealed class SqliteGridAdjustmentStore : IGridAdjustmentStore
{
    private readonly IDbContextFactory<SholtoDbContext> _factory;

    public SqliteGridAdjustmentStore(IDbContextFactory<SholtoDbContext> factory) { _factory = factory; }
