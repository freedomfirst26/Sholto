...
public static class ControlSurface
{
    ...
    public static readonly AttachedProperty<string?> IdProperty =
        AvaloniaProperty.RegisterAttached<Control, string?>("Id", typeof(ControlSurface));
    ...
    public static readonly AttachedProperty<int> DeckProperty =
        AvaloniaProperty.RegisterAttached<Control, int>("Deck", typeof(ControlSurface), defaultValue: -1);
    ...
    public static readonly AttachedProperty<string?> HitForProperty =
        AvaloniaProperty.RegisterAttached<Control, string?>("HitFor", typeof(ControlSurface));
