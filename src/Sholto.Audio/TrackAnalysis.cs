...
public sealed class TrackAnalysis
{
    ...
    /// <summary>Fires when model-based song sections land, from an optional external
    /// analyser producing higher-quality labels than the built-in heuristic. No
    /// current implementation exists (see TODO.md); kept as type-driven machinery
