...
/// <summary>RBJ Audio EQ Cookbook biquad (direct form I), per-channel state.
/// Lives in Sholto.Analysis (not next to Sholto.Audio's DSP effects) because
/// <see cref="WaveformPeakAnalyzer"/> needs it and Sholto.Analysis has no
/// project reference to Sholto.Audio — Sholto.Audio already references
/// Sholto.Analysis, so the reverse would be a cycle.</summary>
