...
/// <summary>
/// SQLite-backed track + analysis cache. Single file at ~/.local/share/opendj/library.db.
...
/// </summary>
public sealed class OpenDjDatabase : IAsyncDisposable
{
    ...
    private OpenDjDatabase(SqliteConnection conn, string path)
    {
        _conn = conn;
        DatabasePath = path;
    }

    public static async Task<OpenDjDatabase> OpenAsync()
    {
        ...
        return new OpenDjDatabase(conn, path);
    }
