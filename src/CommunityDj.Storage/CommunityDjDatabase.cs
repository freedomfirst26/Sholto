...
/// <summary>
/// SQLite-backed track + analysis cache. Single file at ~/.local/share/communitydj/library.db.
...
/// </summary>
public sealed class CommunityDjDatabase : IAsyncDisposable
{
    ...
    private CommunityDjDatabase(SqliteConnection conn, string path)
    {
        _conn = conn;
        DatabasePath = path;
    }

    public static async Task<CommunityDjDatabase> OpenAsync()
    {
        var dir = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.UserProfile),
            ".local", "share", "communitydj");
        ...
        return new CommunityDjDatabase(conn, path);
    }
